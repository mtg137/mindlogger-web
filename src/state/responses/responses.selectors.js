...
export const currentAppletTokenBalanceSelector = createSelector(currentAppletResponsesSelector, (responseHistory) => {
...
export const currentScreenResponseSelector = createSelector(currentResponsesSelector, (progress) => {
  return progress ? progress.responses[progress.screenIndex] : progress;
});

export const screenResponsesSelector = createSelector(currentResponsesSelector, (progress) => {
  return progress ? progress.responses : progress;
});

export const currentScreenIndexSelector = createSelector(currentResponsesSelector, (progress) => {
