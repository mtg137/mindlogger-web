...
const appletSlice = createSlice({
  ...
  reducers: {
    ...
    selectApplet: (state, action) => {
      state.applet = action.payload;
    },
    selectActivity: (state, action) => {
      state.activityAccess = action.payload;
    },
    setCumulativeActivities: (state, action) => {
      state.cumulativeActivities = { ...action.payload };
    },
  ...
  extraReducers: {
    [`${APPLET_CONSTANTS.GET_APPLETS}/pending`]: (state, action) => {
      state.loading = true;
      state.error = null;
    },
    ...
    [`${APPLET_CONSTANTS.GET_PUBLIC_APPLET}/pending`]: (state, action) => {
      state.loading = true;
      state.error = null;
    },
...
export const { clearApplets, selectApplet, selectActivity, prepareResponseKeys, setCumulativeActivities, setProfiles } =
  appletSlice.actions;
